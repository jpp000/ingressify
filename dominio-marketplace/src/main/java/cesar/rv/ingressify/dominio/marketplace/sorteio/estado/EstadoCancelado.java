...
public class EstadoCancelado implements EstadoSorteio {

    @Override
    public void abrirInscricoes(Sorteio sorteio) {
        throw new IllegalStateException("sorteio cancelado");
    }
    ...
    public void cancelar(Sorteio sorteio) {
        throw new IllegalStateException("sorteio já está cancelado");
    }

    @Override
    public StatusSorteio getStatus() {
        return StatusSorteio.CANCELADO;
    }
}
